                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('product#create')}}" method="post" novalidate="novalidate" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input id="cc-pament" name="pizzaName" type="text" value="{{old('pizzaName')}}" class="form-control @error('pizzaName')
                            ...
                            <div class="form-group">
                               ...
                               <select name="pizzaCategory" value="{{old('pizzaCategory')}}" class="form-control @error('pizzaCategory')
                                is-invalid @enderror">
                            ...
                            <div class="form-group">
                                ...
                                is-invalid @enderror" cols="30" rows="10" placeholder="Enter Description...">{{old('pizzaDescription')}}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                is-invalid @enderror" aria-required="true" aria-invalid="false" placeholder="Enter Waiting Time...">
