    ...
    <div class="container-fluid pb-5">
        <div class="row px-xl-5">
            <div class="col-lg-5 mb-30">
                ...
                <a href="{{ route('user#home') }}" class="text-descoration-none text-dark">
                    <i class="fa-solid fa-arrow-left me-1"></i>
                </a>
                <div id="product-carousel" class="carousel slide mt-5" data-ride="carousel">
                    <div class="carousel-inner bg-light">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="{{ url('image/' . $pizza->image) }}" alt="Image">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-7 h-auto mb-30 mt-3">
                <div class="h-100 bg-light p-30">
                    ...
                    <div class="d-flex align-items-center mb-4 pt-2">
                        ...
                        <button class="btn btn-warning px-3" id="addCartBtn"><i class="fa fa-shopping-cart mr-1"></i> Add To
                            Cart</button>
                    </div>
                    ...
                    @foreach ($pizzaList as $p)
                        <div class="product-item bg-light">
                            <div class="product-img position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="{{ url('image/'. $p->image) }}" style="height:250px;"
                                    alt="">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#addCartBtn').click(function() {
                ...
                $source = {
                    'count': $('#orderCount').val(), //new variable
                    'userId': $('#userId').val(),
                    'pizzaId': $('#pizzaId').val()
                };
